...
export function MonitorEditor({ mode = "edit" }: { mode?: "view" | "edit" }) {
  ...
  return (
    <div className={cn("space-y-6", editing && "pb-24")}>
      <div className="sticky top-[calc(var(--app-header-height)+env(safe-area-inset-top)-1px)] z-10 -mx-3 -mt-4 space-y-2 border-b border-border bg-background/95 px-3 py-2 backdrop-blur sm:-mx-4 sm:-mt-6 sm:px-4">
        <button
          type="button"
